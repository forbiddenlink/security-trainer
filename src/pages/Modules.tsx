  ...
  return (
    <div className="space-y-6 max-w-5xl mx-auto animate-in fade-in duration-500">
      <div className="flex flex-col gap-2">
        <h1 className="text-3xl font-bold">Active Operations</h1>
              ...
              <div className="flex flex-col md:flex-row gap-6 justify-between items-start md:items-center relative z-10">
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground max-w-xl group-hover:text-foreground/80 transition-colors">
                      {module.description}
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-6">
                  ...
                  {isLocked ? (
                    <button
                      disabled
                      className="flex items-center gap-2 px-6 py-3 rounded-lg bg-muted text-muted-foreground font-bold cursor-not-allowed border border-transparent"
                    >
