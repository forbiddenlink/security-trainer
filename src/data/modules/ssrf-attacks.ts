...
export const ssrfAttacks: Module = {
  ...
  description:
    "Master the art of detecting and preventing attacks where servers are tricked into making unauthorized requests.",
  difficulty: "Advanced",
  xpReward: 400,
  locked: false,
  lessons: [
...
sequenceDiagram
    ...
    participant Meta as AWS Metadata 169.254.169.254

    Attacker->>App: url=http://169.254.169.254/.../credentials
    App->>Meta: Server-side fetch (trusted)
    Meta->>App: IAM role credentials
    App->>Attacker: Returns cloud secrets
\`\`\`

::video[https://www.youtube.com/watch?v=bfHZRK5v2OA]{title="SSRF Explained" caption="Server-Side Request Forgery and cloud metadata attacks"}
...
5. **AWS IMDSv2**: Use token-based metadata service
    ...
    },
    {
      ...
      quiz: {
        question:
          "What makes SSRF particularly dangerous in cloud environments?",
        options: [
        ...
        correctAnswer: 1,
        explanation:
          "Cloud metadata services are accessible from any application running on the instance. SSRF allows attackers to make requests to these endpoints and steal IAM credentials. This was the core of the Capital One breach.",
      },
    },
    {
      id: "ssrf-quiz-2",
      ...
      quiz: {
        question:
          "An application has an 'Import from URL' feature that fetches images. Which input would indicate an SSRF attack attempt?",
        options: [
        ...
        correctAnswer: 1,
        explanation:
          "The IP 169.254.169.254 is the AWS metadata endpoint. An attacker requesting this URL is attempting SSRF to steal cloud credentials.",
      },
    },
    {
      id: "ssrf-quiz-3",
      ...
      quiz: {
        question:
          "Which defense provides the STRONGEST protection against SSRF attacks?",
        options: [
        ...
        correctAnswer: 2,
        explanation:
          "A combination of domain allowlisting AND blocking internal IP ranges provides defense in depth. Blocking only the metadata IP misses other internal services.",
      },
    },
    {
      id: "ssrf-quiz-4",
      ...
      quiz: {
        question:
          "An application blocks 'localhost' and '127.0.0.1'. Which URL could bypass this protection?",
        options: [
        ...
        correctAnswer: 3,
        explanation:
          "SSRF filters are often bypassed using: case variations (LOCALHOST), alternative representations (0.0.0.0), or IPv6 (::1). Robust protection requires blocking ALL private/internal ranges.",
      },
    },
    {
      id: "ssrf-quiz-5",
      ...
      quiz: {
        question:
          "In the 2019 Capital One breach, what did the attacker retrieve using SSRF?",
        options: [
        ...
        correctAnswer: 1,
        explanation:
          "The attacker used SSRF to query the AWS metadata service and obtained temporary AWS credentials assigned to the server's IAM role.",
      },
    },
    {
      id: "ssrf-lab",
      ...
      type: "lab",
      content:
        "The function below fetches content from a user-provided URL without any validation. Your mission: Implement URL validation to prevent SSRF attacks.",
      lab: {
        initialCode: `
...
function isPrivateIP(hostname) {
  ...
  return false;
                ...
                `,
        instructions:
          "Implement SSRF protection: 1) Parse URL, 2) Check protocol is 'https:', 3) Validate hostname against allowedDomains, 4) Block private IPs with isPrivateIP() function.",
      },
    },
  ],
};
